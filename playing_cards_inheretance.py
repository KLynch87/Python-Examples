...
class Joker_Card(Card):
    """ The Joker Card. """
    def __str__(self):
        rep = super(Joker_Card, self).__str__()
        rep += ": Upset the established order, and everything becomes chaos."
        return rep
...
card4 = Joker_Card("Joke","r")

print("printing the joker card:")
print(card4)
print("the", card4.rank, "is on you!")
